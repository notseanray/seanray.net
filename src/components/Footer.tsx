...
const Footer = () => {
    return(
        <footer class="flex text-center justify-center">
            ...
            <FooterLink link="https://www.linkedin.com/in/sean-ray/" icon={linkedin} />
            <FooterLink link="https://open.spotify.com/user/rahhkj5ivyqfse41t221zzjgw?si=507be134fff6462f" icon={spotify} />
