        ...
        <div class="">
                    ...
                    <div class="flex">
                        ...
                        <div class="pl-0.5">
                            ...
                            <div class="text-sm text-slate-300 text-left">
                                ...
                                {user()?.data?.active_on_discord_desktop
                                    ? " on desktop"
                                    : ""}{" "}
                                {user()?.data?.active_on_discord_mobile
                                    ? " on mobile"
                                    : ""}
                            </div>
                        </div>
            ...
            <div class="m-1 p-4 bg-stone-800 shadow flex max-w-xs rounded-md hover:shadow-lg">
                {!user()?.data?.spotify && (
                    <>
                        <img
                            class="h-16 rounded-md items-center"
                            src={placeholder}
                            alt=""
                        />
                ...
                {user()?.data?.spotify && (
                    <>
                        <>
                            <img
                                class="h-16 rounded-md items-center"
                                src={user()?.data?.spotify?.album_art_url}
                                alt=""
                            />
                        </>
                        <div class="pl-3.5">
                            <div class="text-sm text-slate-50 text-left">
                                {user()?.data?.spotify?.song} by{" "}
                                {user()?.data?.spotify?.artist}
                            </div>
                            <div class="text-sm text-slate-300 text-left">
                                ...
                                <a
                                    ...
                                    href={
                                        ...
                                        user()?.data?.spotify?.track_id
                                    }
                                    target="_blank"
                                    rel="noopener noreferrer"
                                >
                                    Listen to {user()?.data?.spotify?.song} on
                                    Spotify
                                </a>
                            </div>
                        </div>
