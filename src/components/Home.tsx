...
const Home = () => {
    const ssh_key = "echo \"ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIHhssm/d0+mNX2cAhohgwOCRBjYCIQzylzRD2Hwr8lrr sean@seanray.net\" >> ~/.ssh/authorized_keys";
    // const ssh_key = "";
    ...
    <>
        ...
        <div class="flex text-center justify-center bg-color w-4/12 text-xl text-blue-200">
          👋
          <br />
          I'm a {age}-year-old aspiring Full Stack/Backend developer. 
        </div>
      </div>
      ...
      <div class="my-3 flex text-center justify-center">
        <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=notseanray&langs_count=12&theme=dark&layout=compact" alt="" />
      </div>
      <div class="text-xl text-slate-200">
        Discord
      </div>
